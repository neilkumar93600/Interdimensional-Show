...
const Switcher3 = ({ checked, onChange }) => {
    return (
        ...
        <div className='relative'>
            ...
            <div className={`dot absolute left-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-white transition-transform duration-300 ${checked ? 'translate-x-6' : ''}`}>
